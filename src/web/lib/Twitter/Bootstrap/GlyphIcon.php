<?php
/**
 * Theme Warlock - Twitter_Bootstrap_GlyphIcon
 * 
...
class Twitter_Bootstrap_GlyphIcon {
    ...
    const GLYPH_CD = 'cd';
    const GLYPH_SAVE_FILE = 'save-file';
    const GLYPH_OPEN_FILE = 'open-file';
    const GLYPH_LEVEL_UP = 'level-up';
    const GLYPH_COPY = 'copy';
    const GLYPH_PASTE = 'paste';
    const GLYPH_ALERT = 'alert';
    const GLYPH_EQUALIZER = 'equalizer';
    const GLYPH_KING = 'king';
    const GLYPH_QUEEN = 'queen';
    const GLYPH_PAWN = 'pawn';
    const GLYPH_BISHOP = 'bishop';
    const GLYPH_KNIGHT = 'knight';
    const GLYPH_BABY_FORMULA = 'baby-formula';
    const GLYPH_TENT = 'tent';
    const GLYPH_BLACKBOARD = 'blackboard';
    const GLYPH_BED = 'bed';
    const GLYPH_APPLE = 'apple';
    const GLYPH_ERASE = 'erase';
    const GLYPH_HOURGLASS = 'hourglass';
    const GLYPH_LAMP = 'lamp';
    const GLYPH_DUPLICATE = 'duplicate';
    const GLYPH_PIGGY_BANK = 'piggy-bank';
    const GLYPH_SCISSORS = 'scissors';
    const GLYPH_BITCOIN = 'bitcoin';
    const GLYPH_BTC = 'btc';
    const GLYPH_XBT = 'xbt';
    const GLYPH_YEN = 'yen';
    const GLYPH_JPY = 'jpy';
    const GLYPH_RUBLE = 'ruble';
    const GLYPH_RUB = 'rub';
    const GLYPH_SCALE = 'scale';
    const GLYPH_ICE_LOLLY = 'ice-lolly';
    const GLYPH_ICE_LOLLY_TASTED = 'ice-lolly-tasted';
    const GLYPH_EDUCATION = 'education';
    const GLYPH_OPTION_HORIZONTAL = 'option-horizontal';
    const GLYPH_OPTION_VERTICAL = 'option-vertical';
    const GLYPH_MENU_HAMBURGER = 'menu-hamburger';
    const GLYPH_MODAL_WINDOW = 'modal-window';
    const GLYPH_OIL = 'oil';
    const GLYPH_GRAIN = 'grain';
    const GLYPH_SUNGLASSES = 'sunglasses';
    const GLYPH_TEXT_SIZE = 'text-size';
    const GLYPH_TEXT_COLOR = 'text-color';
    const GLYPH_TEXT_BACKGROUND = 'text-background';
    const GLYPH_OBJECT_ALIGN_TOP = 'object-align-top';
    const GLYPH_OBJECT_ALIGN_BOTTOM = 'object-align-bottom';
    const GLYPH_OBJECT_ALIGN_HORIZONTAL = 'object-align-horizontal';
    const GLYPH_OBJECT_ALIGN_LEFT = 'object-align-left';
    const GLYPH_OBJECT_ALIGN_VERTICAL = 'object-align-vertical';
    const GLYPH_OBJECT_ALIGN_RIGHT = 'object-align-right';
    const GLYPH_TRIANGLE_RIGHT = 'triangle-right';
    const GLYPH_TRIANGLE_LEFT = 'triangle-left';
    const GLYPH_TRIANGLE_BOTTOM = 'triangle-bottom';
    const GLYPH_TRIANGLE_TOP = 'triangle-top';
    const GLYPH_CONSOLE = 'console';
    const GLYPH_SUPERSCRIPT = 'superscript';
    const GLYPH_SUBSCRIPT = 'subscript';
    const GLYPH_MENU_LEFT = 'menu-left';
    const GLYPH_MENU_RIGHT = 'menu-right';
    const GLYPH_MENU_DOWN = 'menu-down';
    const GLYPH_MENU_UP  = 'menu-up ';
