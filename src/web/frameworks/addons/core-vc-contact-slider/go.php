<?php
/**
 * Theme Warlock - Addon_CoreVcContactSlider
 * 
 * @title      WPBakery Page Builder - Contact Form Slider
...
class Addon_CoreVcContactSlider extends Addon {
     ...
     * @var string
     */
    public static $addonIcon = Twitter_Bootstrap_GlyphIcon::GLYPH_MAP_MARKER;
    ...
    public static function getOptions() {
        return array(
            ...
            (new Model_Project_Config_Item_String(self::KEY_DESCRIPTION))
                ->setValue('Display a sliding contact form and map')
                ->setIsTextarea(true)
            ...
            (new Model_Project_Config_Item_String(self::KEY_DEF_SECT_SUBTITLE))
                ->setValue('Sliding contact form and map')
    ...
    public function getPlugins() {
        return array(
            Plugin::PLUGIN_VC_CONTACT_SLIDER,
        );
    }
    ...
    public function onPluginDeployment(Drawables_Plugin_Common $pluginCommon) {
        switch ($pluginCommon->getPlugin()->getName()) {
            case Plugin::PLUGIN_VC_CONTACT_SLIDER:
